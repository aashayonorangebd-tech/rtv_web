  ...
  return (
    <>
      <style>{`
        ...
        .player-wrapper:fullscreen .player-inside {
          width: 100% !important;
          ...
          <div className="max-sm:col-span-12 md:col-span-9">
            <div className="content-section">
              ...
              <div className="py-2 max-md:pt-0">
                ...
                {hasVideo && (
                  <div className="no-print ml-2.5 mt-4 mb-3 flex items-center gap-2">
                    <button type="button" onClick={handlePlay} className="rounded bg-blue-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-blue-700">প্লে</button>
                    <button type="button" onClick={handleFullscreen} className="rounded bg-slate-700 px-3 py-1.5 text-sm font-medium text-white hover:bg-slate-800">ফুলস্ক্রিন</button>
                  </div>
                )}
