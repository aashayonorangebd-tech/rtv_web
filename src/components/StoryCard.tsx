...
<h3 className="font-bold text-rtv-text-dark dark:text-white group-hover:text-rtv-blue-text-hover hover:cursor-pointer pt-2 pb-3 text-[25px] leading-[30px] transition-colors line-clamp-3">
  {story.mainTitle}
</h3>
...
export function StoryCardMedium({ story }: { story: StoryModel }) {
  return (
    ...
    >
      ...
      <h3 className="font-bold text-[18px] md:text-[15px] lg:text-[15px] leading-[20px] md:leading-[20px] lg:leading-[20px] h-[40px] text-rtv-text-dark dark:text-white group-hover:text-rtv-blue-text-hover dark:group-hover:text-blue-300 transition-colors line-clamp-2">
        {story.mainTitle}
      </h3>
    </a>
  );
