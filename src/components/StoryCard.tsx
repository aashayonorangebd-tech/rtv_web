...
<h3 className="font-bold text-[#121212] dark:text-white group-hover:text-rtv-blue-text-hover hover:cursor-pointer pt-2 pb-3 text-[25px] leading-[30px] transition-colors line-clamp-3">
  {story.mainTitle}
</h3>
...
export function StoryCardMedium({ story }: { story: StoryModel }) {
  return (
    ...
    >
      ...
      <h3 className="font-bold text-[18px] md:text-[15px] lg:text-[15px] leading-[20px] md:leading-[20px] lg:leading-[20px] h-[40px] text-[#121212] dark:text-white group-hover:text-rtv-blue-text-hover dark:group-hover:text-blue-300 transition-colors line-clamp-2">
        {story.mainTitle}
      </h3>
    </a>
  );
  ...
  return (
    <a href={`/story/${story.storyId}`} className="group flex gap-3.5 mb-5 last:mb-0">
      ...
      <div className="flex-1 min-w-0 flex flex-col justify-center">
        <h3 className="text-[16px] md:text-[17px] font-bold leading-[25px] text-[#121212] dark:text-white group-hover:text-rtv-blue-text-hover dark:group-hover:text-blue-300 transition-colors line-clamp-3">
          {story.mainTitle}
        </h3>
...
export function StoryCardListItem({ story }: { story: StoryModel }) {
  return (
    <a href={`/story/${story.storyId}`} className="group flex gap-3 py-3 border-b border-[#dddddd] dark:border-gray-800 last:border-b-0">
      ...
      <div className="flex-1 min-w-0 flex flex-col justify-center">
        <h3 className="text-[16px] font-medium leading-[24px] text-[#121212] dark:text-white group-hover:text-rtv-blue-text-hover dark:group-hover:text-blue-300 transition-colors line-clamp-2">
          {story.mainTitle}
        </h3>
...
export function StoryCardText({ story }: { story: StoryModel }) {
  return (
    <a href={`/story/${story.storyId}`} className="group block py-3 border-b border-[#dddddd] dark:border-gray-800 last:border-b-0">
      <h3 className="text-[16px] font-medium leading-[25px] text-[#121212] dark:text-white group-hover:text-rtv-blue-text-hover dark:group-hover:text-blue-300 transition-colors line-clamp-2">
        {story.mainTitle}
      </h3>
