          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-12">
            ...
            <div className="md:col-span-8">
              ...
              >
                ...
                <h3 className="font-bold text-rtv-text-dark dark:text-white group-hover:text-rtv-blue-text-hover hover:cursor-pointer pt-2 text-3xl pb-3 leading-[1.3] transition-colors">
                  {lead.mainTitle}
                </h3>
              ...
              {rightColStories.map((story, index) => (
                <div key={story.storyId}>
                  ...
                  >
                    ...
                    <h3 className="font-bold text-rtv-text-dark dark:text-white group-hover:text-rtv-blue-text-hover hover:cursor-pointer pt-2 text-xl pl-1 pb-2 leading-[1.3] transition-colors">
                      {story.mainTitle}
                    </h3>
                  </a>
